...
import co.id.web.exception.MyForbiddenException;
import co.id.web.exception.MyPreconditionFailedException;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleBadRequest(final RuntimeException ex, final WebRequest request){
        final String bodyOfResponse = "This should be application spesific";
